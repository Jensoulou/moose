...
[Outputs]
  #file_base = 'test/tests/lower_dimensional_kernel/mass_vol_exp_ld_NodeMappingGenerator' #'lower_dimensional_kernel/mass_vol_exp_ld'
  file_base = mass_vol_exp_ld_NodeMappingGenerator
  [csv]
    type = CSV
  []
  exodus = true
